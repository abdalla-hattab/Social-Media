    ...
    const topRowHtml = `
        <div class="sm-header-banner" style="margin-bottom: 24px; display: flex; flex-direction: column; align-items: flex-start; gap: 16px;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; width: 100%; padding: 6px; border-radius: 8px; outline: none; box-shadow: none;">
                ...
                <div style="display: flex; gap: 8px;">
                    <!-- Description Button -->
                    <a href="https://description.masaratkobra.com" target="_blank" style="display: flex; align-items: center; gap: 8px; background: #8b5cf6; color: white; padding: 8px 16px; border-radius: 8px; font-weight: 700; text-decoration: none; font-size: 14px; border: 1px solid #7c3aed; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: all 0.2s;" onmouseover="this.style.background='#7c3aed'; this.style.transform='translateY(-1px)'" onmouseout="this.style.background='#8b5cf6'; this.style.transform='translateY(0)'" title="الذهاب إلى Description">
